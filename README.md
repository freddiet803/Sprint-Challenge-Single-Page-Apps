...
> Answer:
    ...
    Another advantage is that when you edit one route, assuming you’ve structured your code well,
    you don’t have to worry about it breaking stuff on another route.

    also, cdns and easy deployment
